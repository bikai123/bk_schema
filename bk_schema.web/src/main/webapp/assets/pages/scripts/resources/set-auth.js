...
var setAuth = function () {
  ...
  var configMap = {
    path: '',
    authDataUrl: '/resources/resource',
    userAuthUrl: '/users/userauth',
    roleAuthUrl: '/roles/roleauth',
    orgAuthUrl: '/organization/orgauth',
    id: '',
    optType: ''
  };
  ...
  var initAuth = function () {
    ...
    var treeData = [];
    $.ajax({
      url: configMap.path + configMap.authDataUrl,
      type: 'GET',
      async: false,
      success: function (result) {
        treeData = result;
