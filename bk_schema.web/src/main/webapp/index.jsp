...
<head>
    ...
    <link href="<%=request.getContextPath()%>/assets/global/plugins/bootstrap/css/bootstrap.min.css"
          rel="stylesheet" type="text/css"/>
     <link href="<%=request.getContextPath()%>/assets/global/plugins/bootstrap/css/my.css" 
           rel="stylesheet" type="text/css"/>     
    <link href="<%=request.getContextPath()%>/assets/global/plugins/uniform/css/uniform.default.css"
          rel="stylesheet" type="text/css"/>
   <link href="<%=request.getContextPath()%>/assets/global/plugins/websocketInstantMsg/css/websocket.css" 
           rel="stylesheet" type="text/css"/> 
     <link href="<%=request.getContextPath()%>/assets/global/plugins/websocketInstantMsg/ext4/resources/css/ext-all.css" 
          rel="stylesheet" type="text/css"/>  
    <!-- 第三方类库样式（结束） -->
    ...
    <link href="<%=request.getContextPath()%>/assets/global/plugins/jquery-layout/layout-default-latest.css"
          rel="stylesheet" type="text/css"/>
    <link href="<%=request.getContextPath()%>/assets/global/plugins/bootstrap-fileinput/css/fileinput.min.css"
          rel="stylesheet" type="text/css"/>
    <link href="<%=request.getContextPath()%>/assets/global/plugins/ystep/css/ystep.css"
          rel="stylesheet" type="text/css"/>     
    <link href="<%=request.getContextPath()%>/assets/global/plugins/dist/css/skins/_all-skins.min.css"
          rel="stylesheet" type="text/css"/>
    <link href="<%=request.getContextPath()%>/assets/global/plugins/dist/css/AdminLTE.min.css"
              rel="stylesheet" type="text/css"/> 
    <link href="<%=request.getContextPath()%>/assets/global/plugins/treegrid/css/jquery.treegrid.css"
              rel="stylesheet" type="text/css"/>             
    ...
    <link href="<%=request.getContextPath()%>/assets/layouts/layout/css/layout.css"
          rel="stylesheet" type="text/css"/>
    <link href="<%=request.getContextPath()%>/assets/layouts/layout/css/themes/darkblue.css"
...
<div class="page-header navbar navbar-fixed-top">
    <div class="page-header-inner ">
        <div class="page-logo">
            <a href="#">
                <span class="logo-default">太阳能项目管理系统</span> </a>
        </div>
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
               <li class="dropdown dropdown-message">
                <a class="dropdown-toggle"  onclick="socket.creatw()"  style="color:white; font-size:15px;">                                                      
                                                      实时通讯
                </a>
                </li>
                <li class="dropdown dropdown-message">
                <a class="dropdown-toggle" onclick="message()"  style="color:white; font-size:15px;">
                <span class="badge" style="background:red">1</span>                                      
                                                        系统消息&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </a>
                </li>
                <li class="dropdown dropdown-words">
                <a class="dropdown-toggle" onclick="words()" style="color:white; font-size:15px;">
...
<script src="<%=request.getContextPath()%>/assets/global/plugins/canvas-to-blob.min.js"
        type="text/javascript"></script>

<script src="<%=request.getContextPath()%>/assets/global/plugins/bootstrap-fileinput/js/fileinput.min.js"></script>
<script src="<%=request.getContextPath()%>/assets/global/plugins/bootstrap-fileinput/js/zh.js"></script>
...
<script src="<%=request.getContextPath()%>/assets/global/scripts/app.js"
        type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/assets/layouts/layout/scripts/layout.js"
        type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/assets/layouts/global/scripts/bootstrap-addtabs.js"
        type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/assets/global/plugins/websocketInstantMsg/ext4/ext-all-debug.js"
        type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/assets/global/plugins/websocketInstantMsg/websocket.js"
        type="text/javascript"></script>    
<script src="<%=request.getContextPath()%>/assets/global/plugins/ystep/js/ystep.js"
        type="text/javascript"></script>    
<script src="<%=request.getContextPath()%>/assets/global/plugins/treegrid/jquery.treegrid.bootstrap3.js"
        type="text/javascript"></script> 
<script src="<%=request.getContextPath()%>/assets/global/plugins/treegrid/jquery.treegrid.js"
        type="text/javascript"></script>                                            
</body>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $.get('<%=request.getContextPath()%>/index', null, function (result) {
            if (result) {
                ...
                sysuser.name=result.userinfo;
                sysuser.id=result.userid;
            }
        });

        $.get('<%=request.getContextPath()%>/getsysinfo', null, function (result) {
            if (result) {
                var title = result.title ? result.title : '太阳能项目管理系统';
                $('.logo-default').text(title);
                $('title').text(title);
                $('.page-footer-inner').text(result.copyright ? result.copyright : '太阳能项目管理系统');
